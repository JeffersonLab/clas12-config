...
# copy the file from /group/clas12/packages/clara/4.3.12_6.5.12/plugins/clas12/etc/bankdefs/util/bankSplit.py
#new dst schema will add "BAND::banks","BAND::adc","BAND::tdc","BAND::hits","BAND::rawhits",
...
dst = ["BAND::banks","BAND::adc","BAND::tdc","BAND::hits","BAND::rawhits","BAND::laser","RUN::config","RAW::epics","RAW::scaler","REC::Event","REC::Particle","REC::Calorimeter","REC::Cherenkov","REC::CovMat","REC::ForwardTagger","REC::Scintillator","REC::ScintExtras","REC::Track","REC::Traj","RECFT::Event","RECFT::Particle","RICH::tdc","RICH::ringCher","RICH::hadCher","RTPC::tracks","RUN::scaler","HEL::flip","HEL::online","MC::Event","MC::Header","MC::Lund","MC::Particle","MC::True"]
