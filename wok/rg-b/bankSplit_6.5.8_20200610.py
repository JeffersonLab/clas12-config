...
# copy the file from /group/clas12/packages/clara/4.3.12_6.5.8/plugins/clas12/etc/bankdefs/util/bankSplit.py
#new dst schema will add "BAND::adc","BAND::tdc","BAND::hits","BAND::rawhits",
